<?PHP 
	...
	if(isset($_POST['userID']) && isset($_POST['boxID'])){
			...
			//$returnTime = date(NULL); //$_POST['returnTime'];
			$estimated = $_POST['estimated'];
			
            $query = "INSERT INTO `rent_table` (`UserID`, `BoxID`, `BorrowTime`, `ReturnTime`, `EstimateTime`) 
			VALUES ('$userID', '$boxID', '$borrowTime', NULL, '$estimated')";
